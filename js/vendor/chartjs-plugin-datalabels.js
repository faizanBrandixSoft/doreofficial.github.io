  ...
  var s = {
      ...
      point: function (t, e, n, a) {
        ...
        return (
          ...
          d(t.x + r.x * o, t.y + r.y * o, r.x, r.y, n)
        );
      },
  ...
  v.extend(b.prototype, {
    ...
    update: function (t) {
      ...
      v.options.resolve([o.display, !0], t, i) &&
        ...
        (r = (a = v.isNullOrUndef(n) ? [] : g.toTextLines(n)).length
        ...
        (function (t, e, n, a) {
          ...
          if (d && u)
            for (
              ...
              t.fillText(e[o], Math.round(r), Math.round(i), Math.round(n.w)),
                (i += s);
        })(t, x.lines, e.text, x),
        t.restore());
    },
  ...
  function f(t, e) {
    ...
    if (i.enter || i.leave) {
      ...
      (n = r.hovered),
        ...
        (u = a),
        ((s = n) || u) &&
          (s ? (u ? s.label !== u.label && (f = d = !0) : (f = !0)) : (d = !0),
          f && h(o, l.leave, s),
          d && h(o, l.enter, u));
    }
  }
      ...
      beforeEvent: function (t, e) {
        if (t[m].listened)
          switch (e.type) {
            ...
            case "click":
              (a = e),
                (r = (n = t)[m].listeners.click),
                (i = r && c(n, a.x, a.y)) && h(n, r, i);
          }
        var n, a, r, i;
      },
