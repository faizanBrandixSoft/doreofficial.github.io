...
!(function (t, i) {
  ...
  function yt(t) {
    var i = t.match(wt);
    return (
      i && (i[1] !== vt.protocol || i[2] !== vt.hostname || i[3] !== vt.port)
    );
  }
  function Mt(t) {
  ...
  function Dt(t, i) {
    var e = t.pageX,
      a = t.pageY,
      n = { endX: e, endY: a };
    return i ? n : _({ startX: e, startY: a }, n);
  }
  ...
  var Et = {
      ...
      initContainer: function () {
        ...
        et(a, { width: (this.containerData = n).width, height: n.height }),
          at(t, S),
          nt(a, S);
      },
      initCanvas: function () {
        ...
        (c.left = (t.width - r) / 2),
          ...
          (this.initialImageData = _({}, i)),
          (this.initialCanvasData = _({}, c));
      },
              ...
              (c
                ...
                : s &&
                  ((c = o.width) < (d = o.height) * r
                    ? (c = d * r)
                    : (d = c / r)));
          var l = kt({ aspectRatio: r, width: c, height: d });
          (c = l.width),
            (d = l.height),
            (n.minWidth = c),
            (n.minHeight = d),
      ...
      renderImage: function (t) {
        ...
        _(e, {
          ...
          et(
            ...
            _(
              { width: e.width, height: e.height },
              Ct(_({ translateX: e.left, translateY: e.top }, e))
            )
          ),
          t && this.output();
      },
      ...
      output: function () {
        this.preview(), ut(this.element, a, this.getData());
      },
    },
    Ht = {
      ...
      resetPreview: function () {
        J(this.previews, function (t) {
          var i = st(t, g);
          et(t, { width: i.width, height: i.height }),
            (t.innerHTML = i.html),
            dt(t, g);
        });
      },
      preview: function () {
        ...
        this.cropped &&
          ...
          (et(
            ...
            _(
              { width: d, height: l },
              Ct(_({ translateX: -p, translateY: -m }, r))
            )
          ),
          J(this.previews, function (t) {
            var i = st(t, g),
            ...
            s && (o = c * (h = e / s)),
              c && a < o && ((n = s * (h = a / c)), (o = a)),
              et(t, { width: n, height: o }),
              et(
                t.getElementsByTagName("img")[0],
                _(
                  { width: d * h, height: l * h },
                  Ct(_({ translateX: -p * h, translateY: -m * h }, r))
                )
              );
          }));
      },
          ...
          t.changedTouches
            ...
            (a =
              1 < Object.keys(e).length && i.zoomable && i.zoomOnTouch
                ...
                : st(t.target, m)),
            I.test(a) &&
              !1 !== ut(this.element, w, { originalEvent: t, action: a }) &&
              (t.preventDefault(),
              (this.action = a),
              (this.cropping = !1),
              a === T && ((this.cropping = !0), at(this.dragBox, o)));
        }
      },
      cropMove: function (t) {
        var i = this.action;
        if (!this.disabled && i) {
          var e = this.pointers;
          t.preventDefault(),
            !1 !== ut(this.element, v, { originalEvent: t, action: i }) &&
              (t.changedTouches
                ? J(t.changedTouches, function (t) {
                    _(e[t.identifier], Dt(t, !0));
                  })
                : _(e[t.pointerId || 0], Dt(t, !0)),
              this.change(t));
        }
      },
      cropEnd: function (t) {
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            i &&
              ...
              this.cropping &&
                ((this.cropping = !1),
                ot(this.dragBox, o, this.cropped && this.options.modal)),
              ut(this.element, f, { originalEvent: t, action: i }));
        }
      },
    },
    zt = {
      change: function (t) {
        ...
        !r && t.shiftKey && (r = d && l ? d / l : 1),
          this.limited &&
            ((g = n.minLeft),
            (u = n.minTop),
            (f = g + Math.min(a.width, e.width, e.left + e.width)),
            (v = u + Math.min(a.height, e.height, e.top + e.height)));
        var b,
          y,
          M,
          C = o[Object.keys(o)[0]],
        ...
        switch (h) {
          ...
          case Y:
            if (r) {
              ...
              B(O), (l -= D.y), (c += D.y), (d = l * r), (s += n.width - d);
            } else
              B(O),
                B(H),
                D.x <= 0
    ...
    Yt = {
      crop: function () {
        return (
          !this.ready ||
            ...
            ((this.cropped = !0),
            this.limitCropBox(!0, !0),
            this.options.modal && at(this.dragBox, o),
            nt(this.cropBox, S),
      ...
      clear: function () {
        return (
          this.cropped &&
            !this.disabled &&
            (_(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
            (this.cropped = !1),
            this.renderCropBox(),
            this.limitCanvas(!0, !0),
            this.renderCanvas(),
      ...
      enable: function () {
        return (
          this.ready &&
            this.disabled &&
            ((this.disabled = !1), nt(this.cropper, t)),
          this
        );
      },
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), at(this.cropper, t)),
          this
        );
      },
      destroy: function () {
      ...
      zoomTo: function (t, i, e) {
        ...
        if (
          ...
          if (
            !1 ===
            ut(this.element, A, { ratio: t, oldRatio: s / d, originalEvent: e })
          )
            return this;
          if (e) {
            var g = this.pointers,
      ...
      getCroppedCanvas: function () {
        ...
        var i,
          ...
          P =
            ...
            (L = H.getContext("2d")),
            (O = kt({ aspectRatio: g, width: D, height: k })),
            (z = kt({ aspectRatio: g, width: W, height: E }, "cover")),
            (Y = Math.min(O.width, Math.max(z.width, u))),
            (X = Math.min(O.height, Math.max(z.height, f))),
            (R = kt({ aspectRatio: o, width: D, height: k })),
            (S = kt({ aspectRatio: o, width: W, height: E }, "cover")),
        ...
        ct <= -Z || rt < ct
          ? (ut = mt = lt = ct = 0)
          : ct <= 0
          ? ((mt = -ct), (ct = 0), (ut = lt = Math.min(rt, Z + ct)))
          : ct <= rt && ((mt = 0), (ut = lt = Math.min(Z, rt - ct))),
          lt <= 0 || dt <= -F || st < dt
            ? (ft = gt = pt = dt = 0)
            : dt <= 0
            ? ((gt = -dt), (dt = 0), (ft = pt = Math.min(st, F + dt)))
            : dt <= st && ((gt = 0), (ft = pt = Math.min(F, st - dt)));
        var vt = [ct, dt, lt, pt];
        if (0 < ut && 0 < ft) {
          var wt = tt / Z;
                    ...
                    if (U.test(t))
                      j.test(t)
                        ? this.read(
                            ...
                            J((r = new Uint8Array(h)), function (t, i) {
                              r[i] = o.charCodeAt(i);
                            }),
                            h)
                          )
              ...
              value: function () {
                if (this.sized && !this.ready) {
                  ...
                  (this.container = a),
                    ...
                    i.cropBoxResizable ||
                      (at(s.getElementsByClassName(d + "-line"), S),
                      at(s.getElementsByClassName(d + "-point"), S)),
                    this.render(),
                    (this.ready = !0),
                    this.setDragMode(i.dragMode),
                    i.autoCrop && this.crop(),
                    this.setData(i.data),
                    G(i.ready) && gt(t, C, i.ready, { once: !0 }),
                    ut(t, C);
                }
              },
            },
  ...
  return _(Rt.prototype, Et, Ht, Lt, Ot, zt, Yt), Rt;
});
